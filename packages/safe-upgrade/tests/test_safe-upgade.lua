...
describe("safe-upgrade tests #safeupgrade", function()
	it("test get_partitions()", function()
		stub(su, "get_uboot_env", function(part_name)
...
mtd8: 00010000 00010000 "ART"
	...
	it("test is_current_board_supported()", function()
		stub(su, "get_supported_devices", function()
			return { "librerouter-v1", "librerouter-v2" }
		end)
		stub(su, "get_current_device", function()
			return "librerouter-v1"
		end)
		assert.is_true(su.is_current_board_supported())
		stub(su, "get_current_device", function()
			return "librerouter-v2"
		end)
		assert.is_true(su.is_current_board_supported())
		stub(su, "get_current_device", function()
			return ""
	...
	it("test preserve_files_to_new_partition preserve some", function()
		...
		stub(utils, "keep_on_upgrade_files", function()
			return { preserve_file, preserve_inexistent_file }
		end)
