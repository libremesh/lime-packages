...
describe("Tests network_nodes #network_nodes", function()
	...
	it("test node creation and serialization", function()
		stub(utils, "release_info", function()
			return { DISTRIB_RELEASE = "2021.1" }
		end)
		stub(utils, "current_board", function()
			return "devboard"
		end)
		...
		assert.are.same(
			node,
			network_nodes._deserialize_from_network_nodes(network_nodes._serialize_for_network_nodes(node))
		)
	end)
	...
	it("test get_nodes return expected format #get_nodes", function()
		...
		uci:commit("network")
		local node1 =
			network_nodes._node("node1", true, "2021.1", "librerouter-v1", "10.24.3.97", "fd0d:fe46:8ce8::ab:cd00")
		local node2 =
			network_nodes._node("node2", true, "2020.3", "librerouter-v1", "10.24.3.98", "fd0d:fe46:8ce8::ab:cd01")
		local node3 =
			network_nodes._node("node3", true, "2020.1", "tplink-wdr3600", "10.24.3.98", "fd0d:fe46:8ce8::ab:cd02")
