...
function usbradio.detect_hardware()
	...
	for path in stdOutput:lines() do
		...
		if config.autogenerable(sectionName) then
			...
			--! TODO: working on all 802.11bgn devices; find a general way for working in different devices
			uci:set("wireless", radioName, "channel", "11")
			--! TODO: working on all 802.11gn devices; find a general way for working in different devices
			uci:set("wireless", radioName, "band", "2g")
