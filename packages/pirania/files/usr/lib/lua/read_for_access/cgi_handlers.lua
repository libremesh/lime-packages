...
function handlers.authorize_mac()
    ...
    if with_vouchers then
        return uci:get("pirania", "base_config", "url_auth") or '/portal/auth.html'
    end
    ...
    local url_authenticated = uci:get("pirania", "base_config", "url_authenticated") or '/portal/authenticated.html'
