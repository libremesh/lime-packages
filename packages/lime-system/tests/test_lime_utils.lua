...
describe("LiMe Utils tests #limeutils", function()
	...
	it("test set_password", function()
		stub(os, "execute", function(cmd)
			return cmd
		end)
		assert.is.equal(
			"(echo 'mypassword'; sleep 1; echo 'mypassword') | passwd 'root' >/dev/null 2>&1",
...
dnsmasq:*:18362:0:99999:7:::
	...
	it("test set_shared_root_password", function()
		...
		stub(utils, "set_password", function(_, pass)
			return pass
		end)
	...
	it("test random_string", function()
		...
		assert.is.equal(
			"number",
			type(tonumber(utils.random_string(5, function(c)
	...
	it("test mac2ipv6linklocal", function()
		...
		assert.is.equal(
			"FOOfe80::aa40:41ff:fe1c:84d1BARfe80::aa40:41ff:fe1c:84d1",
