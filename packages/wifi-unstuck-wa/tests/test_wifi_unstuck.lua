...
describe("Wireless unstuck workarounds #unstuck", function()
	...
	it("test get scan freq for iface", function()
		stub(nixio, "exec", function()
			return true
		end)
		stub(nixio, "fork", function()
			return 0
		end)
		stub(nixio, "nanosleep", function()
			return true
		end)
		stub(os, "exit", function()
			return true
		end)
	...
	it("test pid-timeout-table", function()
		...
		stub(unstuck_wa, "wait_and_kill_on_timeout", function()
			return true
		end)
		...
		assert.stub(unstuck_wa.wait_and_kill_on_timeout).was.called_with({ [11271] = 10000, [11272] = 10000 })
	end)
