...
local publish_hostname = domains:option(
	Flag,
	"publish_hostname",
	translate("Publish hostname"),
...
local hosts = domains:option(
	DynamicList,
	"host",
	translate("Own domains"),
